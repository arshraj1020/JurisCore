package com.juriscore.casemanagement.support;
 ...
 *
 * <p>Needed because {@code TenantGuard} and {@code CurrentUser} read the caller rather
 * than taking one as an argument — which is the right design, since a guard that can be
 * handed the wrong tenant is not a guard — but it does mean a service test has to say who
 * is calling.
 */
